# This Makefile is for the RT::AjaxyReplyPage extension to perl.
#
...
#     ABSTRACT => q[RT AjaxyReplyPage Extension]
#     DIR => []
#     DISTNAME => q[RT-AjaxyReplyPage]
#     INSTALLSITELIB => q[/opt/rt3/local/lib]
#     NAME => q[RT::AjaxyReplyPage]
#     NO_META => q[1]
#     PL_FILES => {  }
#     PREREQ_PM => {  }
#     VERSION => q[undef]
...
DIRFILESEP = /
DFSEP = $(DIRFILESEP)
NAME = RT::AjaxyReplyPage
NAME_SYM = RT_AjaxyReplyPage
VERSION = undef
...
MAKE = make
FULLEXT = RT/AjaxyReplyPage
BASEEXT = AjaxyReplyPage
PARENT_NAME = RT
DLBASE = $(BASEEXT)
VERSION_FROM = 
OBJECT = 
...
TO_INST_PM = lib/RT/AjaxyReplyPage.pm

PM_TO_BLIB = lib/RT/AjaxyReplyPage.pm \
	blib/lib/RT/AjaxyReplyPage.pm
...
DISTNAME = RT-AjaxyReplyPage
DISTVNAME = RT-AjaxyReplyPage-undef
...
ppd:
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>RT AjaxyReplyPage Extension</ABSTRACT>' >> $(DISTNAME).ppd
...
pm_to_blib : $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')' -- \
	  lib/RT/AjaxyReplyPage.pm blib/lib/RT/AjaxyReplyPage.pm 
